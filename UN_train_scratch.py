...
parser = argparse.ArgumentParser(description='Original model training')
# Basic Settings
...
def main_worker(gpu, ngpus_per_node, args):
    log_path = './runs/training_history/original_model/%s/%s/trial_%s/' % (args.dataset, args.model, args.trial)
    ...
    for epoch in tqdm(range(args.start_epoch, args.epochs)):
        ...
        args.tb_logger.scalar_summary('TEST/acc1', test_acc1, args.current_epoch)
        args.tb_logger.scalar_summary('TEST/acc5', test_acc5, args.current_epoch)
        args.tb_logger.scalar_summary('TEST/loss', test_loss, args.current_epoch)
        ############################################
